...
<div style="position: absolute; width: 1340px; height: 690px; left: 50px; top: 210px; background: #0C0D1F; border-radius: 10px;">
    <div>
        <img src="../Rectangle 17.png" alt="" style="position: relative; width: 840px; height: 600px; left: 480px; top: 30px;">
    </div>
    <div style="position: absolute; width: 56px; height: 48px; left: 10px; top: 10px;">
        <img src="../image 15.png" alt="" style="border-radius: 10px;">
    </div>
</div>
